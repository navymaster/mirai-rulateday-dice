...
public class RollController {
    ...
    public String randomCocRole(MessageData data) {
        return rollRole.createCocRole(Integer.valueOf(data.getMessage().equals("")?0:data.getMessage()));
    }

    @InstructReflex(value = {".dnd", "。dnd"})
    public String randomDndRole(MessageData data) {
        return rollRole.createDndRole(Integer.valueOf(data.getMessage().equals("")?0:data.getMessage()));
    }
